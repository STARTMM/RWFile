...
public class ExtractSubMap extends AbsReadFile {
	public static String out_file_dir = "/Users/ywj/Documents/road/submap2009all/map2009_newOrigin.wkt";
...
//		FileWriter fw_t4 = new FileWriter(out4);
		...
		{
			node = queue.dequeue();
			this.used_nodes.add(node);//�����оͻᱻ����Ϊ����
...
//				}
			...
			System.out.println("*begin to find map*");
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		String dir_in = "/Users/ywj/Documents/road/submap2009all/meter_beijing.txt";
